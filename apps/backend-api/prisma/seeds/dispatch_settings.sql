...
VALUES
  ...
  ('silver_commission',        '15',  'Commission rate (%) for Silver-tier drivers (0-2 total rides)',       NOW()),
  ('gold_commission',          '10',  'Commission rate (%) for Gold-tier drivers (≥3 total rides)',          NOW()),
  ('premier_commission',       '8',   'Commission rate (%) for Premier-tier drivers (≥30 rides this week)', NOW()),
