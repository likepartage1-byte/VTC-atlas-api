...
const profileAr = {
  ...
  color_midnight_navy: 'كحلي ليلي',
  color_emerald_green: 'أخضر زمردي',
  color_champagne_gold: 'ذهبي شامبانيا',
  color_chocolate_brown: 'بني شوكولاتة',
  color_warm_orange: 'برتقالي دافئ',
  color_burgundy_wine: 'أحمر نبيذي',
  ...
  // PersonalInfo validation errors
  ...
  name_cannot_be_default: 'يرجى إدخال الاسم الحقيقي بدلاً من الاسم الافتراضي.',
  sec_photos_title: '📸 1. صور المركبة والبطاقة الرمادية',
  sec_identity_title: '🚘 2. معلومات السيارة والماركة',
  sec_specs_title: '⚙️ 3. المواصفات الفنية',
  sec_plate_title: '📋 4. أرقام الترقيم والبطاقة الرمادية',
  incomplete_title: '⚠️ بيانات غير مكتملة',
  incomplete_body: 'يرجى إكمال ملء الخانات والصور التالية قبل الحفظ:',
  confirm_save_title: '📋 تأكيد حفظ التعديلات',
  confirm_save_msg: 'هل أنت متأكد من صحة جميع المعلومات والصور التي قمت بإدخالها وتريد إرسالها للمراجعة؟',
  confirm_send: 'تأكيد وإرسال',
  select_vehicle_type: 'اختر نوع المركبة',
  type_car: 'سيارة (Car)',
  type_car_sub: 'تسجيل معلومات السيارة ورخصتها',
  type_moto: 'دراجة نارية (Motorcycle)',
  type_moto_sub: 'تسجيل مواصفات وثائق الدراجة النارية',
};
...
const profileFr = {
  ...
  documents: 'Documents',
  payment_info: 'Portefeuille et Paiement',
  ...
  color_midnight_navy: 'Bleu Nuit',
  color_emerald_green: 'Vert Émeraude',
  color_champagne_gold: 'Or Champagne',
  color_chocolate_brown: 'Brun Chocolat',
  color_warm_orange: 'Orange Chaleureux',
  color_burgundy_wine: 'Rouge Bordeau',
  ...
  name_cannot_be_default: 'Veuillez saisir un vrai prénom et nom de famille.',
  sec_photos_title: '📸 1. Photos du véhicule et carte grise',
  sec_identity_title: '🚘 2. Informations du véhicule et marque',
  sec_specs_title: '⚙️ 3. Spécifications techniques',
  sec_plate_title: '📋 4. Immatriculation et carte grise',
  incomplete_title: '⚠️ Informations incomplètes',
  incomplete_body: 'Veuillez remplir les éléments et photos suivants avant d\'enregistrer :',
  confirm_save_title: '📋 Confirmation de la mise à jour',
  confirm_save_msg: 'Êtes-vous sûr de la précision de toutes les informations et photos saisies ?',
  confirm_send: 'Confirmer et envoyer',
  select_vehicle_type: 'Sélectionner le type de véhicule',
  type_car: 'Voiture (Car)',
  type_car_sub: 'Enregistrer les détails de la voiture',
  type_moto: 'Moto (Motorcycle)',
  type_moto_sub: 'Enregistrer les détails de la moto',
};
...
const profileEn = {
  ...
  color_midnight_navy: 'Midnight Navy',
  color_emerald_green: 'Emerald Green',
  color_champagne_gold: 'Champagne Gold',
  color_chocolate_brown: 'Chocolate Brown',
  color_warm_orange: 'Warm Orange',
  color_burgundy_wine: 'Burgundy Wine',
  ...
  name_cannot_be_default: 'Please enter your real first and last name.',
  sec_photos_title: '📸 1. Vehicle & Registration Photos',
  sec_identity_title: '🚘 2. Vehicle Details & Brand',
  sec_specs_title: '⚙️ 3. Technical Specifications',
  sec_plate_title: '📋 4. Registration & Plate Numbers',
  incomplete_title: '⚠️ Incomplete Information',
  incomplete_body: 'Please complete the following fields and photos before saving:',
  confirm_save_title: '📋 Confirm Vehicle Update',
  confirm_save_msg: 'Are you sure all entered vehicle details and photos are accurate and ready for review?',
  confirm_send: 'Confirm & Send',
  select_vehicle_type: 'Select Vehicle Type',
  type_car: 'Car',
  type_car_sub: 'Register car details and documents',
  type_moto: 'Motorcycle',
  type_moto_sub: 'Register motorcycle details and documents',
};
...
const profileEs = {
  ...
  payment_info: 'Billetera y Pagos',
  ...
  color_midnight_navy: 'Azul Marino',
  color_emerald_green: 'Verde Esmeralda',
  color_champagne_gold: 'Oro Champaña',
  color_chocolate_brown: 'Marrón Chocolate',
  color_warm_orange: 'Naranja Cálido',
  color_burgundy_wine: 'Rojo Borgoña',
  ...
  first_name_required: 'Por favor ingrese su nombre.',
  last_name_required: 'Por favor ingrese su apellido.',
  name_cannot_be_default: 'Por favor ingrese su nombre y apellido real.',
  sec_photos_title: '📸 1. Fotos del vehículo y tarjeta de registro',
  sec_identity_title: '🚘 2. Información del vehículo y marca',
  sec_specs_title: '⚙️ 3. Especificaciones técnicas',
  sec_plate_title: '📋 4. Registro y matrícula',
  ...
  confirm_save_title: '📋 Confirmación de actualización',
  confirm_save_msg: '¿Está seguro de la precisión de toda la información y fotos ingresadas?',
  confirm_send: 'Confirmar y enviar',
  select_vehicle_type: 'Seleccionar Tipo de Vehículo',
  type_car: 'Automóvil (Coche)',
  type_car_sub: 'Registrar detalles y documentos del coche',
  type_moto: 'Motocicleta',
  type_moto_sub: 'Registrar detalles y documentos de la moto',
};
...
const resources = {
  ar: {
    translation: {
      ...
      onboarding_title1: 'ابدأ القيادة مع Yalla VTC',
      onboarding_desc1: 'انضم إلى آلاف السائقين وابدأ في استقبال الرحلات خلال دقائق.',
      onboarding_title2: 'وثائقك في أمان',
      onboarding_desc2: 'جميع الوثائق تتم مراجعتها وحمايتها وفق أعلى معايير الأمان.',
      onboarding_title3: 'اربح وفق وقتك',
      onboarding_desc3: 'اختر أوقات العمل المناسبة لك وتتبع أرباحك بسهولة.',
      onboarding_start_reg: 'ابدأ التسجيل',
      onboarding_continue: 'متابعة',
      onboarding_skip: 'تخطي',
      welcome_auth_title: 'أنشئ حسابك',
      welcome_auth_google: 'متابعة بواسطة Google',
      welcome_auth_apple: 'متابعة بواسطة Apple',
      welcome_auth_phone: 'متابعة برقم الهاتف',
      welcome_auth_coming_soon: 'سيتم تفعيل هذه الميزة قريبًا.',
      welcome_auth_has_account: 'لديك حساب بالفعل؟',
      welcome_auth_signin: 'تسجيل الدخول',
    },
    wallet: walletAr,
    profile: profileAr,
  },
  fr: {
    translation: {
      ...
      profile: 'Profil',
      onboarding_title1: 'Commencez à conduire avec Yalla VTC',
      onboarding_desc1: 'Rejoignez des milliers de chauffeurs et commencez à recevoir des courses en quelques minutes.',
      onboarding_title2: 'Vos documents sont en sécurité',
      onboarding_desc2: 'Tous les documents sont vérifiés et protégés selon les normes de sécurité les plus strictes.',
      onboarding_title3: 'Gagnez selon votre horaire',
      onboarding_desc3: 'Choisissez les heures de travail qui vous convient et suivez vos gains facilement.',
      onboarding_start_reg: "Commencer l'inscription",
      onboarding_continue: 'Continuer',
      onboarding_skip: 'Passer',
      welcome_auth_title: 'Créez votre compte',
      welcome_auth_google: 'Continuer avec Google',
      welcome_auth_apple: 'Continuer avec Apple',
      welcome_auth_phone: 'Continuer avec le numéro de téléphone',
      welcome_auth_coming_soon: 'Cette fonctionnalité sera bientôt disponible.',
      welcome_auth_has_account: 'Vous avez déjà un compte ?',
      welcome_auth_signin: 'Se connecter',
    },
    wallet: walletFr,
    profile: profileFr,
  },
  en: {
    translation: {
      ...
      performance: 'Performance',
      profile: 'Profile',
      onboarding_title1: 'Start driving with Yalla VTC',
      onboarding_desc1: 'Join thousands of drivers and start receiving rides in minutes.',
      onboarding_title2: 'Your documents are secure',
      onboarding_desc2: 'All documents are reviewed and protected according to the highest security standards.',
      onboarding_title3: 'Earn on your schedule',
      onboarding_desc3: 'Choose the working hours that suit you and track your earnings easily.',
      onboarding_start_reg: 'Start Registration',
      onboarding_continue: 'Continue',
      onboarding_skip: 'Skip',
      welcome_auth_title: 'Create your account',
      welcome_auth_google: 'Continue with Google',
      welcome_auth_apple: 'Continue with Apple',
      welcome_auth_phone: 'Continue with Phone Number',
      welcome_auth_coming_soon: 'This feature will be available soon.',
      welcome_auth_has_account: 'Already have an account?',
      welcome_auth_signin: 'Sign In',
    },
    wallet: walletEn,
    profile: profileEn,
  },
  es: {
    translation: {
      ...
      profile: 'Perfil',
      onboarding_title1: 'Empieza a conducir con Yalla VTC',
      onboarding_desc1: 'Únete a miles de conductores y empieza a recibir viajes en minutos.',
      onboarding_title2: 'Tus documentos están seguros',
      onboarding_desc2: 'Todos los documentos se revisan y protegen según los estándares de seguridad más altos.',
      onboarding_title3: 'Gana según tu horario',
      onboarding_desc3: 'Elige el horario de trabajo que te convenga y realiza un seguimiento de tus ganancias fácilmente.',
      onboarding_start_reg: 'Iniciar registro',
      onboarding_continue: 'Continuar',
      onboarding_skip: 'Omitir',
      welcome_auth_title: 'Crea tu cuenta',
      welcome_auth_google: 'Continuar con Google',
      welcome_auth_apple: 'Continuar con Apple',
      welcome_auth_phone: 'Continuar con número de teléfono',
      welcome_auth_coming_soon: 'Esta función estará disponible pronto.',
      welcome_auth_has_account: '¿Ya tienes una cuenta?',
      welcome_auth_signin: 'Iniciar sesión',
    },
    wallet: walletEs,
    profile: profileEs,
  },
